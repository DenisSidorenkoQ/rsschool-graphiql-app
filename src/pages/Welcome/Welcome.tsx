import { Col, Image, Layout, Row, Button, theme, Space } from 'antd';
  ...
  return (
    <Layout className="layout">
        ...
        <Row justify="space-around" align={'middle'}>
          <Col xs={24} sm={24} md={12} lg={14}>
            <Paragraph strong style={{ textAlign: 'center' }}>
              ...
              solutions to complex problems. We believe that GraphQL is the future of APIs, and we
              are committed to building tools that make it easier for developers to work with this
              powerful technology.
            </Paragraph>
          </Col>
        ...
        <Row justify="space-around" align="middle">
          ...
          <Col xs={24} sm={24} md={12} lg={12}>
            <Paragraph strong style={{ textAlign: 'center' }}>
              ...
              levels to experiment with GraphQL queries and learn more about this exciting
              technology.
            </Paragraph>
          </Col>
        </Row>
      ...
      <Footer style={{ textAlign: 'center' }}>
        <div className="site-layout-footer">Footer</div>
      </Footer>
    </Layout>
  );
};
