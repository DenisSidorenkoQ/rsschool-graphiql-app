...
export const Main = () => {
    ...
    const [graphQLRequest, setGraphQLRequest] = React.useState(
    ...
    <>
        ...
        {!validateGithubToken && (
            <div style={{textAlign: "center", alignItems: "center"}}>
                <span>Before proceeding further please validate your token. To generate token refer <a href='https://github.com/settings/tokens'>this</a>.</span>
                <Input
                    status={githubToken}
                    placeholder="Token"
        ...
        {validateGithubToken && (
            <>
                <div className="wrapper">
                    <div id="codeEditor">
                        <div style={{textAlign: 'center', fontSize: 20, borderRadius: '10px'}}><span>Request</span></div>
                        <CodeEditor
